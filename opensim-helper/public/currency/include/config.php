...
if (!defined('ENV_HELPER_URL'))  define('ENV_HELPER_URL',  'http://www.virtualworld.space/currency/helper/');
if (!defined('ENV_HELPER_PATH')) define('ENV_HELPER_PATH', '/usr/share/nginx/html/currency/helper/');

//////////////////////////////////////////////////////////////////////////////////i
// Valiables for OpenSim

// Please set MySQL DB access information
define('OPENSIM_DB_HOST', '192.168.1.249');
define('OPENSIM_DB_NAME', 'robust');
define('MONEY_DB_NAME', 'money');
define('OPENSIM_DB_USER', 'opensimuser');
define('OPENSIM_DB_PASS', 'opensimdb99');
//
...
define('CURRENCY_CONV_RATE_TBL',    'convrate');
